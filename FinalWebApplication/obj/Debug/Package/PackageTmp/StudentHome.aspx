<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="StudentHome.aspx.cs" Inherits="FinalWebApplication.Home" EnableViewStateMac="false"%>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">    
    ...
    <asp:Table runat="server">
        <asp:TableRow>
            <asp:TableCell>
                <asp:Label runat="server" Text="Please enter first 3 digits of your Id followed by Favourite Course Number"></asp:Label>
            </asp:TableCell>
            <asp:TableCell><asp:TextBox ID="txtCourseNo" runat="server"></asp:TextBox></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell>
                <asp:Button ID="btnCourseNo" runat="server" OnClick="btnCourseNo_Click" Text="Course" />
            </asp:TableCell>
            <asp:TableCell>
                <asp:Label runat="server" ID="lblCourseResult"></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
